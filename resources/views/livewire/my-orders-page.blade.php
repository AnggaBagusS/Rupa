                ...
                @foreach ($orders as $order)
                  ...
                  @php
                    ...
                    if ($order->status == 'new') {
                      ...
                      $status = '<span class="bg-green-500 py-1 px-3 rounded text-white shadow">Processing</span>';
                    } elseif ($order->status == 'shipped') {
                      $status = '<span class="bg-yellow-500 py-1 px-3 rounded text-white shadow">Shipped</span>';
                    ...
                    if ($order->payment_status == 'pending') {
                      ...
                      $payment_status = '<span class="bg-green-600 py-1 px-3 rounded text-white shadow">Completed</span>';
